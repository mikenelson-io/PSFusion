...
Get the configuration object 'PSFConfiguration'.
...
#>
function Get-PSFConfiguration {

    $Configuration = $Script:Configuration

    if ([string]::IsNullOrEmpty($Configuration["BaseUrl"])) {
        $Configuration["BaseUrl"] = "https://api.pure1.purestorage.com/fusion/api/1.1";
    }
...
None
#>
function Set-PSFConfigurationApiKey {
    [CmdletBinding()]
    Param(
        [string]$Id,
        [AllowEmptyString()]
...
None
#>
function Set-PSFConfigurationApiKeyPrefix {
    [CmdletBinding()]
    Param(
        [string]$Id,
        [AllowEmptyString()]
...
None
#>
function Set-PSFConfigurationDefaultHeader {
    [CmdletBinding()]
    Param(
        [string]$Key,
        [AllowEmptyString()]
...
System.Collections.Hashtable[]
#>
function Get-PSFHostSetting {
    return ,@(
          @{
            "Url" = "https://api.pure1.purestorage.com/fusion/api/1.1";
...
String
#>
function Get-PSFUrlFromHostSetting {
...
System.Collections.Hashtable
#>
function Set-PSFConfigurationHttpSigning {
    [CmdletBinding()]
    param(
    ...
    Process {
        ...
        $keyType = Get-PSFKeyTypeFromFile -KeyFilePath $KeyFilePath
...
Get the configuration object 'PSFConfigurationHttpSigning'.
...
[PSCustomObject]
#>
function Get-PSFConfigurationHttpSigning{
