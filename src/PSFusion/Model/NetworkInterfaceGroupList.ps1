...
NetworkInterfaceGroupList<PSCustomObject>
#>

function Initialize-PSFNetworkInterfaceGroupList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFNetworkInterfaceGroupList' | Write-Debug
...
Convert from JSON to NetworkInterfaceGroupList<PSCustomObject>
...
NetworkInterfaceGroupList<PSCustomObject>
#>
function ConvertFrom-PSFJsonToNetworkInterfaceGroupList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFNetworkInterfaceGroupList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFNetworkInterfaceGroupList
