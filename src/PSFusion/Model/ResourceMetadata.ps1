...
function Initialize-PSFResourceMetadata {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFResourceMetadata' | Write-Debug
...
Convert from JSON to ResourceMetadata<PSCustomObject>
...
ResourceMetadata<PSCustomObject>
#>
function ConvertFrom-PSFJsonToResourceMetadata {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFResourceMetadata' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFResourceMetadata
        $AllProperties = ("id", "name", "self_link", "display_name")
