...
function Initialize-PSFRoleAssignmentRef {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFRoleAssignmentRef' | Write-Debug
...
RoleAssignmentRef<PSCustomObject>
#>
function ConvertFrom-PSFJsonToRoleAssignmentRef {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFRoleAssignmentRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFRoleAssignmentRef
