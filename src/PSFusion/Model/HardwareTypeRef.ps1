...
HardwareTypeRef<PSCustomObject>
#>

function Initialize-PSFHardwareTypeRef {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFHardwareTypeRef' | Write-Debug
...
Convert from JSON to HardwareTypeRef<PSCustomObject>
...
HardwareTypeRef<PSCustomObject>
#>
function ConvertFrom-PSFJsonToHardwareTypeRef {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFHardwareTypeRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFHardwareTypeRef
