...
HostAccessPolicy<PSCustomObject>
#>

function Initialize-PSFHostAccessPolicy {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFHostAccessPolicy' | Write-Debug
...
Convert from JSON to HostAccessPolicy<PSCustomObject>
...
HostAccessPolicy<PSCustomObject>
#>
function ConvertFrom-PSFJsonToHostAccessPolicy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFHostAccessPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFHostAccessPolicy
        $AllProperties = ("id", "name", "self_link", "display_name", "iqn", "personality")
