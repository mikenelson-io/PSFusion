...
SnapshotRef<PSCustomObject>
#>

function Initialize-PSFSnapshotRef {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFSnapshotRef' | Write-Debug
...
Convert from JSON to SnapshotRef<PSCustomObject>
...
SnapshotRef<PSCustomObject>
#>
function ConvertFrom-PSFJsonToSnapshotRef {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFSnapshotRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFSnapshotRef
