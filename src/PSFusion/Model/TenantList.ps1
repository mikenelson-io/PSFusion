...
function Initialize-PSFTenantList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFTenantList' | Write-Debug
...
Convert from JSON to TenantList<PSCustomObject>
...
TenantList<PSCustomObject>
#>
function ConvertFrom-PSFJsonToTenantList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFTenantList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFTenantList
