...
SnapshotList<PSCustomObject>
#>

function Initialize-PSFSnapshotList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFSnapshotList' | Write-Debug
...
Convert from JSON to SnapshotList<PSCustomObject>
...
SnapshotList<PSCustomObject>
#>
function ConvertFrom-PSFJsonToSnapshotList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFSnapshotList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFSnapshotList
