...
RoleRef<PSCustomObject>
#>

function Initialize-PSFRoleRef {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFRoleRef' | Write-Debug
...
Convert from JSON to RoleRef<PSCustomObject>
...
RoleRef<PSCustomObject>
#>
function ConvertFrom-PSFJsonToRoleRef {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFRoleRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFRoleRef
