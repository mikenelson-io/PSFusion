...
TenantSpaceList<PSCustomObject>
#>

function Initialize-PSFTenantSpaceList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFTenantSpaceList' | Write-Debug
...
Convert from JSON to TenantSpaceList<PSCustomObject>
...
TenantSpaceList<PSCustomObject>
#>
function ConvertFrom-PSFJsonToTenantSpaceList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFTenantSpaceList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFTenantSpaceList
