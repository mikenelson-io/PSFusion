...
VolumeSnapshotList<PSCustomObject>
#>

function Initialize-PSFVolumeSnapshotList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFVolumeSnapshotList' | Write-Debug
...
Convert from JSON to VolumeSnapshotList<PSCustomObject>
...
VolumeSnapshotList<PSCustomObject>
#>
function ConvertFrom-PSFJsonToVolumeSnapshotList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFVolumeSnapshotList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFVolumeSnapshotList
