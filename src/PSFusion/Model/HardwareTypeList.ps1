...
HardwareTypeList<PSCustomObject>
#>

function Initialize-PSFHardwareTypeList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFHardwareTypeList' | Write-Debug
...
Convert from JSON to HardwareTypeList<PSCustomObject>
...
HardwareTypeList<PSCustomObject>
#>
function ConvertFrom-PSFJsonToHardwareTypeList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFHardwareTypeList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFHardwareTypeList
