...
PlacementGroupRef<PSCustomObject>
#>

function Initialize-PSFPlacementGroupRef {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFPlacementGroupRef' | Write-Debug
...
Convert from JSON to PlacementGroupRef<PSCustomObject>
...
PlacementGroupRef<PSCustomObject>
#>
function ConvertFrom-PSFJsonToPlacementGroupRef {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFPlacementGroupRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFPlacementGroupRef
