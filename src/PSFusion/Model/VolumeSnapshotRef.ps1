...
VolumeSnapshotRef<PSCustomObject>
#>

function Initialize-PSFVolumeSnapshotRef {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFVolumeSnapshotRef' | Write-Debug
...
Convert from JSON to VolumeSnapshotRef<PSCustomObject>
...
VolumeSnapshotRef<PSCustomObject>
#>
function ConvertFrom-PSFJsonToVolumeSnapshotRef {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFVolumeSnapshotRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFVolumeSnapshotRef
