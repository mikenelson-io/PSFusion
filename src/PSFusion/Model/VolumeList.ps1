...
function Initialize-PSFVolumeList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFVolumeList' | Write-Debug
...
Convert from JSON to VolumeList<PSCustomObject>
...
VolumeList<PSCustomObject>
#>
function ConvertFrom-PSFJsonToVolumeList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFVolumeList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFVolumeList
