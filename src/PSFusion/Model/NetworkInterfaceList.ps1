...
NetworkInterfaceList<PSCustomObject>
#>

function Initialize-PSFNetworkInterfaceList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFNetworkInterfaceList' | Write-Debug
...
Convert from JSON to NetworkInterfaceList<PSCustomObject>
...
NetworkInterfaceList<PSCustomObject>
#>
function ConvertFrom-PSFJsonToNetworkInterfaceList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFNetworkInterfaceList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFNetworkInterfaceList
