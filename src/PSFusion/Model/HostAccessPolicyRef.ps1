...
HostAccessPolicyRef<PSCustomObject>
#>

function Initialize-PSFHostAccessPolicyRef {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFHostAccessPolicyRef' | Write-Debug
...
Convert from JSON to HostAccessPolicyRef<PSCustomObject>
...
HostAccessPolicyRef<PSCustomObject>
#>
function ConvertFrom-PSFJsonToHostAccessPolicyRef {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFHostAccessPolicyRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFHostAccessPolicyRef
