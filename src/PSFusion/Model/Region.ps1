...
function Initialize-PSFRegion {
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFRegion' | Write-Debug
...
Region<PSCustomObject>
#>
function ConvertFrom-PSFJsonToRegion {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFRegion' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFRegion
