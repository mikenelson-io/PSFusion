...
RegionList<PSCustomObject>
#>

function Initialize-PSFRegionList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFRegionList' | Write-Debug
...
Convert from JSON to RegionList<PSCustomObject>
...
RegionList<PSCustomObject>
#>
function ConvertFrom-PSFJsonToRegionList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFRegionList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFRegionList
