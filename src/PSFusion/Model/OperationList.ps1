...
OperationList<PSCustomObject>
#>

function Initialize-PSFOperationList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFOperationList' | Write-Debug
...
Convert from JSON to OperationList<PSCustomObject>
...
OperationList<PSCustomObject>
#>
function ConvertFrom-PSFJsonToOperationList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFOperationList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFOperationList
