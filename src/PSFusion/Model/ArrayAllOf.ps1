...
ArrayAllOf<PSCustomObject>
#>

function Initialize-PSFArrayAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFArrayAllOf' | Write-Debug
...
Convert from JSON to ArrayAllOf<PSCustomObject>
...
ArrayAllOf<PSCustomObject>
#>
function ConvertFrom-PSFJsonToArrayAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFArrayAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFArrayAllOf
        $AllProperties = ("apartment_id", "hardware_type", "region", "availability_zone", "appliance_id", "host_name", "maintenance_mode", "unavailable_mode")
        ...
        If ([string]::IsNullOrEmpty($Json) -or $Json -eq "{}") { # empty json
            throw "Error! Empty JSON cannot be serialized due to the required property 'apartment_id' missing."
        }
