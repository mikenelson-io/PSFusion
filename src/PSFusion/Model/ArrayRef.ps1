...
ArrayRef<PSCustomObject>
#>

function Initialize-PSFArrayRef {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFArrayRef' | Write-Debug
...
Convert from JSON to ArrayRef<PSCustomObject>
...
ArrayRef<PSCustomObject>
#>
function ConvertFrom-PSFJsonToArrayRef {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFArrayRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFArrayRef
