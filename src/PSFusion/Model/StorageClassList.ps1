...
StorageClassList<PSCustomObject>
#>

function Initialize-PSFStorageClassList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFStorageClassList' | Write-Debug
...
Convert from JSON to StorageClassList<PSCustomObject>
...
StorageClassList<PSCustomObject>
#>
function ConvertFrom-PSFJsonToStorageClassList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFStorageClassList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFStorageClassList
