...
StorageClassRef<PSCustomObject>
#>

function Initialize-PSFStorageClassRef {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFStorageClassRef' | Write-Debug
...
Convert from JSON to StorageClassRef<PSCustomObject>
...
StorageClassRef<PSCustomObject>
#>
function ConvertFrom-PSFJsonToStorageClassRef {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFStorageClassRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFStorageClassRef
