...
StorageServiceRef<PSCustomObject>
#>

function Initialize-PSFStorageServiceRef {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFStorageServiceRef' | Write-Debug
...
Convert from JSON to StorageServiceRef<PSCustomObject>
...
StorageServiceRef<PSCustomObject>
#>
function ConvertFrom-PSFJsonToStorageServiceRef {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFStorageServiceRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFStorageServiceRef
