...
StorageServiceList<PSCustomObject>
#>

function Initialize-PSFStorageServiceList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFStorageServiceList' | Write-Debug
...
Convert from JSON to StorageServiceList<PSCustomObject>
...
StorageServiceList<PSCustomObject>
#>
function ConvertFrom-PSFJsonToStorageServiceList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFStorageServiceList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFStorageServiceList
