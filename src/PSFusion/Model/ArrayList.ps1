...
function Initialize-PSFArrayList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFArrayList' | Write-Debug
...
Convert from JSON to ArrayList<PSCustomObject>
...
ArrayList<PSCustomObject>
#>
function ConvertFrom-PSFJsonToArrayList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFArrayList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFArrayList
