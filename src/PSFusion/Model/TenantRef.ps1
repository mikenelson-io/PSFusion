...
TenantRef<PSCustomObject>
#>

function Initialize-PSFTenantRef {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFTenantRef' | Write-Debug
...
Convert from JSON to TenantRef<PSCustomObject>
...
TenantRef<PSCustomObject>
#>
function ConvertFrom-PSFJsonToTenantRef {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFTenantRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFTenantRef
