...
PlacementGroupList<PSCustomObject>
#>

function Initialize-PSFPlacementGroupList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFPlacementGroupList' | Write-Debug
...
Convert from JSON to PlacementGroupList<PSCustomObject>
...
PlacementGroupList<PSCustomObject>
#>
function ConvertFrom-PSFJsonToPlacementGroupList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFPlacementGroupList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFPlacementGroupList
