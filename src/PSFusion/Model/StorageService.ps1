...
StorageService<PSCustomObject>
#>

function Initialize-PSFStorageService {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFStorageService' | Write-Debug
...
Convert from JSON to StorageService<PSCustomObject>
...
StorageService<PSCustomObject>
#>
function ConvertFrom-PSFJsonToStorageService {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFStorageService' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFStorageService
        $AllProperties = ("id", "name", "self_link", "display_name", "hardware_types")
