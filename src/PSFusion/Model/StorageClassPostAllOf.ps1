...
StorageClassPostAllOf<PSCustomObject>
#>

function Initialize-PSFStorageClassPostAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFStorageClassPostAllOf' | Write-Debug
...
Convert from JSON to StorageClassPostAllOf<PSCustomObject>
...
StorageClassPostAllOf<PSCustomObject>
#>
function ConvertFrom-PSFJsonToStorageClassPostAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFStorageClassPostAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFStorageClassPostAllOf
        $AllProperties = ("size_limit", "iops_limit", "bandwidth_limit")
