...
NetworkInterfaceGroupRef<PSCustomObject>
#>

function Initialize-PSFNetworkInterfaceGroupRef {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFNetworkInterfaceGroupRef' | Write-Debug
...
Convert from JSON to NetworkInterfaceGroupRef<PSCustomObject>
...
NetworkInterfaceGroupRef<PSCustomObject>
#>
function ConvertFrom-PSFJsonToNetworkInterfaceGroupRef {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFNetworkInterfaceGroupRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFNetworkInterfaceGroupRef
