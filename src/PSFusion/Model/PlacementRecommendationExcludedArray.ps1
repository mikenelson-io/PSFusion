...
PlacementRecommendationExcludedArray<PSCustomObject>
#>

function Initialize-PSFPlacementRecommendationExcludedArray {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFPlacementRecommendationExcludedArray' | Write-Debug
...
Convert from JSON to PlacementRecommendationExcludedArray<PSCustomObject>
...
PlacementRecommendationExcludedArray<PSCustomObject>
#>
function ConvertFrom-PSFJsonToPlacementRecommendationExcludedArray {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFPlacementRecommendationExcludedArray' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFPlacementRecommendationExcludedArray
        $AllProperties = ("id", "name", "kind", "self_link", "reason")
