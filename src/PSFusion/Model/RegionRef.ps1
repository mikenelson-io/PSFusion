...
RegionRef<PSCustomObject>
#>

function Initialize-PSFRegionRef {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFRegionRef' | Write-Debug
...
Convert from JSON to RegionRef<PSCustomObject>
...
RegionRef<PSCustomObject>
#>
function ConvertFrom-PSFJsonToRegionRef {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFRegionRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFRegionRef
