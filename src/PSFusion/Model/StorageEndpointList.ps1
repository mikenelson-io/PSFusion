...
StorageEndpointList<PSCustomObject>
#>

function Initialize-PSFStorageEndpointList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFStorageEndpointList' | Write-Debug
...
Convert from JSON to StorageEndpointList<PSCustomObject>
...
StorageEndpointList<PSCustomObject>
#>
function ConvertFrom-PSFJsonToStorageEndpointList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFStorageEndpointList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFStorageEndpointList
