...
ProtectionPolicyList<PSCustomObject>
#>

function Initialize-PSFProtectionPolicyList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFProtectionPolicyList' | Write-Debug
...
Convert from JSON to ProtectionPolicyList<PSCustomObject>
...
ProtectionPolicyList<PSCustomObject>
#>
function ConvertFrom-PSFJsonToProtectionPolicyList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFProtectionPolicyList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFProtectionPolicyList
