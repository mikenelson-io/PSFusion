...
TenantSpaceRef<PSCustomObject>
#>

function Initialize-PSFTenantSpaceRef {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFTenantSpaceRef' | Write-Debug
...
Convert from JSON to TenantSpaceRef<PSCustomObject>
...
TenantSpaceRef<PSCustomObject>
#>
function ConvertFrom-PSFJsonToTenantSpaceRef {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFTenantSpaceRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFTenantSpaceRef
