...
NetworkInterfaceAllOf<PSCustomObject>
#>

function Initialize-PSFNetworkInterfaceAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFNetworkInterfaceAllOf' | Write-Debug
...
Convert from JSON to NetworkInterfaceAllOf<PSCustomObject>
...
NetworkInterfaceAllOf<PSCustomObject>
#>
function ConvertFrom-PSFJsonToNetworkInterfaceAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFNetworkInterfaceAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFNetworkInterfaceAllOf
        $AllProperties = ("region", "availability_zone", "array", "interface_type", "eth", "fc", "services", "enabled", "network_interface_group", "max_speed")
        ...
        If ([string]::IsNullOrEmpty($Json) -or $Json -eq "{}") { # empty json
            throw "Error! Empty JSON cannot be serialized due to the required property 'interface_type' missing."
        }
