...
StorageEndpointIscsiDiscoveryInterfacePost<PSCustomObject>
#>

function Initialize-PSFStorageEndpointIscsiDiscoveryInterfacePost {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFStorageEndpointIscsiDiscoveryInterfacePost' | Write-Debug
...
Convert from JSON to StorageEndpointIscsiDiscoveryInterfacePost<PSCustomObject>
...
StorageEndpointIscsiDiscoveryInterfacePost<PSCustomObject>
#>
function ConvertFrom-PSFJsonToStorageEndpointIscsiDiscoveryInterfacePost {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFStorageEndpointIscsiDiscoveryInterfacePost' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFStorageEndpointIscsiDiscoveryInterfacePost
        $AllProperties = ("address", "gateway", "network_interface_groups")
