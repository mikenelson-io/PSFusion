...
AvailabilityZoneList<PSCustomObject>
#>

function Initialize-PSFAvailabilityZoneList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFAvailabilityZoneList' | Write-Debug
...
Convert from JSON to AvailabilityZoneList<PSCustomObject>
...
AvailabilityZoneList<PSCustomObject>
#>
function ConvertFrom-PSFJsonToAvailabilityZoneList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFAvailabilityZoneList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFAvailabilityZoneList
