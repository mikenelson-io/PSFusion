...
AvailabilityZoneRef<PSCustomObject>
#>

function Initialize-PSFAvailabilityZoneRef {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFAvailabilityZoneRef' | Write-Debug
...
Convert from JSON to AvailabilityZoneRef<PSCustomObject>
...
AvailabilityZoneRef<PSCustomObject>
#>
function ConvertFrom-PSFJsonToAvailabilityZoneRef {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFAvailabilityZoneRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFAvailabilityZoneRef
