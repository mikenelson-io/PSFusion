...
VolumeRef<PSCustomObject>
#>

function Initialize-PSFVolumeRef {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFVolumeRef' | Write-Debug
...
Convert from JSON to VolumeRef<PSCustomObject>
...
VolumeRef<PSCustomObject>
#>
function ConvertFrom-PSFJsonToVolumeRef {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFVolumeRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFVolumeRef
