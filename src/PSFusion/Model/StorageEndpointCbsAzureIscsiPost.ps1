...
StorageEndpointCbsAzureIscsiPost<PSCustomObject>
#>

function Initialize-PSFStorageEndpointCbsAzureIscsiPost {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSFusion => PSFStorageEndpointCbsAzureIscsiPost' | Write-Debug
...
Convert from JSON to StorageEndpointCbsAzureIscsiPost<PSCustomObject>
...
StorageEndpointCbsAzureIscsiPost<PSCustomObject>
#>
function ConvertFrom-PSFJsonToStorageEndpointCbsAzureIscsiPost {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSFusion => PSFStorageEndpointCbsAzureIscsiPost' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSFStorageEndpointCbsAzureIscsiPost
